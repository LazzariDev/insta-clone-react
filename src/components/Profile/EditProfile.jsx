                        ...
                        <Flex bg={"black"}>
                            <Stack spacing={4} w={"full"} maxW={"md"} bg={"black"} p={6} my={0}>
                                ...
                                <Stack spacing={6} direction={["column", "row"]}>
                                    <Button onClick={onClose} bg={"red.400"} color={"white"} w='full' size='sm' _hover={{ bg: "red.500" }}>
                                        Cancel
                                    </Button>
                                    <Button onClick={handleEditProfile} isLoading={isUpdating} bg={"blue.400"} color={"white"} size='sm' w='full' _hover={{ bg: "blue.500" }}>
                                        Submit
                                    </Button>
                                </Stack>
                            </Stack>
