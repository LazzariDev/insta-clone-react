                            ...
                            <Flex flex={1} flexDir={"column"} px={10} display={{base:"none", md:"flex"}}>
                                <Flex alignItems={"center"} justifyContent={"space-between"}>
                                    ...
                                    <Flex alignItems={"center"} gap={4}>
                                        <Avatar src="/profilepic.png" size={"sm"} name="random guy" />
                                ...
                                <VStack w={"full"} alignItems={"start"} maxH={"350px"} overflowY={"auto"}>
                                    <Comment createdAt="1d ago" username="randomguy" profilePic="/profilepic.png" text={"Dummy images from unsplash"} />
                                    <Comment createdAt="12h ago" username="someguy" profilePic={"https://bit.ly/dan-abramov"} text={"Nice pic"} />
                                    <Comment createdAt="3h ago" username="somefriend" profilePic={"https://bit.ly/kent-c-dodds"} text={"This post is lit"} />
                                </VStack>
